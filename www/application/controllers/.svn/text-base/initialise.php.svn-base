<html>
<head>
<title>Initialise Townguide_ci Databases</title>
</head>
<body>
<?php
...
echo '<h2>select townguide_ci database</h2>';
mysql_select_db("townguide_ci",$link) or die('failed to connect to database townguide_ci: '.mysql_error());
