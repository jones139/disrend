<?php class mapspecs extends CI_Controller {
	...
	public function edit_mapspec($map_id =null) {
		...
		if($this -> form_validation -> run() == FALSE) {
			...
			$this -> load -> view('login_message.php', array('title' => 'ERROR', 'msg' => 'Only an administrator can change the configuration of a different user.'));
		}
