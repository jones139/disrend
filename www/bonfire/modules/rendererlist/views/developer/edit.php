...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Edit rendererList" /> or <?php echo anchor(SITE_AREA .'/developer/rendererlist', lang('rendererlist_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/developer/rendererlist/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('rendererlist_delete_confirm'); ?>')"><?php echo lang('rendererlist_delete_record'); ?></a>
		
		<h3><?php echo lang('rendererlist_delete_record'); ?></h3>
