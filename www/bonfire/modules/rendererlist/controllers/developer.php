...
class developer extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('RendererList.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('RendererList.Developer.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_rendererlist())
			{
				...
				Template::redirect(SITE_AREA .'/developer/rendererlist');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('RendererList.Developer.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/rendererlist');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('RendererList.Developer.Delete');
