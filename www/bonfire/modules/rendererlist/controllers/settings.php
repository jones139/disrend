...
class settings extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('RendererList.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('RendererList.Settings.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_rendererlist())
			{
				...
				Template::redirect(SITE_AREA .'/settings/rendererlist');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('RendererList.Settings.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/rendererlist');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('RendererList.Settings.Delete');
