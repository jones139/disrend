...
class content extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('RendererList.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('RendererList.Content.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_rendererlist())
			{
				...
				Template::redirect(SITE_AREA .'/content/rendererlist');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('RendererList.Content.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/rendererlist');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('RendererList.Content.Delete');
