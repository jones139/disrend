...
class developer extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('JobQueue.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('JobQueue.Developer.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_jobqueue())
			{
				...
				Template::redirect(SITE_AREA .'/developer/jobqueue');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('JobQueue.Developer.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/jobqueue');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('JobQueue.Developer.Delete');
