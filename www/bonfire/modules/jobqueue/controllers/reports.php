...
class reports extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('JobQueue.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('JobQueue.Reports.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_jobqueue())
			{
				...
				Template::redirect(SITE_AREA .'/reports/jobqueue');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('JobQueue.Reports.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/jobqueue');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('JobQueue.Reports.Delete');
