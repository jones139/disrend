...
class settings extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('JobQueue.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('JobQueue.Settings.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_jobqueue())
			{
				...
				Template::redirect(SITE_AREA .'/settings/jobqueue');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('JobQueue.Settings.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/jobqueue');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('JobQueue.Settings.Delete');
