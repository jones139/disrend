...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Edit JobQueue" /> or <?php echo anchor(SITE_AREA .'/settings/jobqueue', lang('jobqueue_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/settings/jobqueue/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('jobqueue_delete_confirm'); ?>')"><?php echo lang('jobqueue_delete_record'); ?></a>
