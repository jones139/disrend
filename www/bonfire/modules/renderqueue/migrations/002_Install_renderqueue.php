...
class Migration_Install_renderqueue extends Migration {
	...
	public function up() 
	{
		...
		$this->dbforge->add_field('`id` int(11) NOT NULL AUTO_INCREMENT');
			$this->dbforge->add_field("`renderqueue_statusid` INT(4) NOT NULL");
			...
			$this->dbforge->add_field("`renderqueue_logfile` BLOB NOT NULL");
			$this->dbforge->add_field("`renderqueue_spare` INT(4) NOT NULL");
