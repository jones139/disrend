...
class content extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('RenderQueue.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('RenderQueue.Content.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_renderqueue())
			{
				...
				Template::redirect(SITE_AREA .'/content/renderqueue');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('RenderQueue.Content.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/renderqueue');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('RenderQueue.Content.Delete');
