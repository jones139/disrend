...
class reports extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('RenderQueue.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('RenderQueue.Reports.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_renderqueue())
			{
				...
				Template::redirect(SITE_AREA .'/reports/renderqueue');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('RenderQueue.Reports.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/renderqueue');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('RenderQueue.Reports.Delete');
