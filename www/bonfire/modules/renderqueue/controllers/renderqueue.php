...
class renderqueue extends Front_Controller {
	...
	*/
	...
	{
		$this->auth->restrict('RenderQueue.Renderqueue.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_renderqueue())
			{
				...
				Template::redirect(SITE_AREA .'/renderqueue/renderqueue');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('RenderQueue.Renderqueue.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/renderqueue/renderqueue');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('RenderQueue.Renderqueue.Delete');
