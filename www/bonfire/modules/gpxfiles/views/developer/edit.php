...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Edit gpxFiles" /> or <?php echo anchor(SITE_AREA .'/developer/gpxfiles', lang('gpxfiles_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/developer/gpxfiles/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('gpxfiles_delete_confirm'); ?>')"><?php echo lang('gpxfiles_delete_record'); ?></a>
