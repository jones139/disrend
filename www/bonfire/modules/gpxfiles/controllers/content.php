...
class content extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('GpxFiles.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('GpxFiles.Content.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_gpxfiles())
			{
				...
				Template::redirect(SITE_AREA .'/content/gpxfiles');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('GpxFiles.Content.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/gpxfiles');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('GpxFiles.Content.Delete');
