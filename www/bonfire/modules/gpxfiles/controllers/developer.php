...
class developer extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('GpxFiles.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('GpxFiles.Developer.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_gpxfiles())
			{
				...
				Template::redirect(SITE_AREA .'/developer/gpxfiles');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('GpxFiles.Developer.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/gpxfiles');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('GpxFiles.Developer.Delete');
