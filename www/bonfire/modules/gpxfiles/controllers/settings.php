...
class settings extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('GpxFiles.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('GpxFiles.Settings.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_gpxfiles())
			{
				...
				Template::redirect(SITE_AREA .'/settings/gpxfiles');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('GpxFiles.Settings.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/gpxfiles');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('GpxFiles.Settings.Delete');
