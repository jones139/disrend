...
class reports extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('GpxFiles.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('GpxFiles.Reports.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_gpxfiles())
			{
				...
				Template::redirect(SITE_AREA .'/reports/gpxfiles');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('GpxFiles.Reports.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/gpxfiles');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('GpxFiles.Reports.Delete');
