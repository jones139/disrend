...
class developer extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('SymbolSets.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('SymbolSets.Developer.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_symbolsets())
			{
				...
				Template::redirect(SITE_AREA .'/developer/symbolsets');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('SymbolSets.Developer.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/symbolsets');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('SymbolSets.Developer.Delete');
