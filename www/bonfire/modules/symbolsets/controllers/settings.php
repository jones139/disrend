...
class settings extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('SymbolSets.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('SymbolSets.Settings.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_symbolsets())
			{
				...
				Template::redirect(SITE_AREA .'/settings/symbolsets');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('SymbolSets.Settings.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/symbolsets');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('SymbolSets.Settings.Delete');
