...
class reports extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('SymbolSets.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('SymbolSets.Reports.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_symbolsets())
			{
				...
				Template::redirect(SITE_AREA .'/reports/symbolsets');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('SymbolSets.Reports.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/symbolsets');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('SymbolSets.Reports.Delete');
