...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Edit SymbolSets" /> or <?php echo anchor(SITE_AREA .'/symbolsets/symbolsets', lang('symbolsets_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/symbolsets/symbolsets/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('symbolsets_delete_confirm'); ?>')"><?php echo lang('symbolsets_delete_record'); ?></a>
