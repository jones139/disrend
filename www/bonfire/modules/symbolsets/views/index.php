...
<div class="view split-view">
	...
	<div class="notification attention">
		<p><?php echo lang('symbolsets_no_records'); ?> <?php echo anchor(SITE_AREA .'/symbolsets/symbolsets/create', lang('symbolsets_create_new'), array("class" => "ajaxify")) ?></p>
	</div>
	...
	<div id="content" class="view">
		<div class="scrollable" id="ajax-content">
			...
			<div class="box create rounded">
				<a class="button good ajaxify" href="<?php echo site_url(SITE_AREA .'/symbolsets/symbolsets/create')?>"><?php echo lang('symbolsets_create_new_button');?></a>
...
?>
				<td><?php echo anchor(SITE_AREA .'/symbolsets/symbolsets/edit/'. $record['id'], lang('symbolsets_edit'), 'class="ajaxify"'); ?></td>
			</tr>
<?php endforeach; ?>
		</tbody>
	</table>
