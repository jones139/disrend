...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Edit MapSpecs" /> or <?php echo anchor(SITE_AREA .'/settings/mapspecs', lang('mapspecs_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/settings/mapspecs/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('mapspecs_delete_confirm'); ?>')"><?php echo lang('mapspecs_delete_record'); ?></a>
