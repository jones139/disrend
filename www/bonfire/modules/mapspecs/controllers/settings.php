...
class settings extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('MapSpecs.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('MapSpecs.Settings.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_mapspecs())
			{
				...
				Template::redirect(SITE_AREA .'/settings/mapspecs');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('MapSpecs.Settings.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/mapspecs');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('MapSpecs.Settings.Delete');
