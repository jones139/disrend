...
class developer extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('MapSpecs.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('MapSpecs.Developer.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_mapspecs())
			{
				...
				Template::redirect(SITE_AREA .'/developer/mapspecs');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('MapSpecs.Developer.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/mapspecs');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('MapSpecs.Developer.Delete');
	...
	*/
	...
	$this->form_validation->set_rules('mapspecs_name','Name','max_length[255]');			
	$this->form_validation->set_rules('mapspecs_mapSpec','MapSpec','');			
	$this->form_validation->set_rules('mapspecs_status','Status','max_length[3]');			
	$this->form_validation->set_rules('mapspecs_imageThumbnail','ImageThumbnail','');			
