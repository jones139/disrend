...
class reports extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('MapSpecs.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('MapSpecs.Reports.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_mapspecs())
			{
				...
				Template::redirect(SITE_AREA .'/reports/mapspecs');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('MapSpecs.Reports.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/mapspecs');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('MapSpecs.Reports.Delete');
