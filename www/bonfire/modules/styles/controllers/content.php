...
class content extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Styles.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Styles.Content.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_styles())
			{
				...
				Template::redirect(SITE_AREA .'/content/styles');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Styles.Content.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/styles');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Styles.Content.Delete');
