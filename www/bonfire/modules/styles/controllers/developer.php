...
class developer extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Styles.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Styles.Developer.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_styles())
			{
				...
				Template::redirect(SITE_AREA .'/developer/styles');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Styles.Developer.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/styles');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Styles.Developer.Delete');
	...
	*/
	...
	$this->form_validation->set_rules('styles_userId','User ID','max_length[3]');			
	$this->form_validation->set_rules('styles_description','Description','max_length[255]');			
	$this->form_validation->set_rules('styles_baseSymbolSetId','Base Symbol Set ID','max_length[3]');			
	$this->form_validation->set_rules('styles_symbolSetId','Symbol Set ID','max_length[3]');			
	$this->form_validation->set_rules('styles_style','Style','');
