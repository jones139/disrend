...
class reports extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Styles.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Styles.Reports.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_styles())
			{
				...
				Template::redirect(SITE_AREA .'/reports/styles');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Styles.Reports.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/styles');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Styles.Reports.Delete');
