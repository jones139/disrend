...
class settings extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Styles.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Styles.Settings.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_styles())
			{
				...
				Template::redirect(SITE_AREA .'/settings/styles');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Styles.Settings.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/styles');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Styles.Settings.Delete');
