...
<div class="view split-view">
	...
	<div class="notification attention">
		<p><?php echo lang('styles_no_records'); ?> <?php echo anchor(SITE_AREA .'/developer/styles/create', lang('styles_create_new'), array("class" => "ajaxify")) ?></p>
	</div>
	...
	<div id="content" class="view">
		<div class="scrollable" id="ajax-content">
			...
			<div class="box create rounded">
				<a class="button good ajaxify" href="<?php echo site_url(SITE_AREA .'/developer/styles/create')?>"><?php echo lang('styles_create_new_button');?></a>
	...
	<table>
		...
		<th>Symbol Set ID</th>
		<th>Style</th><th><?php echo lang('styles_actions'); ?></th>
		</thead>
		<tbody>
<?php
...
?>
				<td><?php echo anchor(SITE_AREA .'/developer/styles/edit/'. $record['id'], lang('styles_edit'), 'class="ajaxify"'); ?></td>
			</tr>
<?php endforeach; ?>
		</tbody>
	</table>
