...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Edit Styles" /> or <?php echo anchor(SITE_AREA .'/content/styles', lang('styles_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/content/styles/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('styles_delete_confirm'); ?>')"><?php echo lang('styles_delete_record'); ?></a>
