...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Edit Status" /> or <?php echo anchor(SITE_AREA .'/reports/status', lang('status_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/reports/status/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('status_delete_confirm'); ?>')"><?php echo lang('status_delete_record'); ?></a>
