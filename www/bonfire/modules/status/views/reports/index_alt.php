<div class="box create rounded">
	...
	<a class="button good" href="<?php echo site_url(SITE_AREA . reports .'/'. status .'/create'); ?>">
	...
	<table>
		...
		<?php foreach ($records as $record) : ?>
			...
			<?php endforeach; ?>
				...
				<td>
					<?php echo anchor(SITE_AREA .'/reports/status/edit/'. $record[$primary_key_field], lang('status_edit'), '') ?>
				</td>
			</tr>
		<?php endforeach; ?>
		</tbody>
