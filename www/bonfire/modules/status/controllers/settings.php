...
class settings extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Status.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Status.Settings.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_status())
			{
				...
				Template::redirect(SITE_AREA .'/settings/status');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Status.Settings.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/status');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Status.Settings.Delete');
