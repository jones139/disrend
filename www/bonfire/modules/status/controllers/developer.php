...
class developer extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Status.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Status.Developer.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_status())
			{
				...
				Template::redirect(SITE_AREA .'/developer/status');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Status.Developer.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/status');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Status.Developer.Delete');
