...
class reports extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Status.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Status.Reports.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_status())
			{
				...
				Template::redirect(SITE_AREA .'/reports/status');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Status.Reports.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/status');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Status.Reports.Delete');
