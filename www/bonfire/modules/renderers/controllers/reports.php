...
class reports extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Renderers.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Renderers.Reports.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_renderers())
			{
				...
				Template::redirect(SITE_AREA .'/reports/renderers');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Renderers.Reports.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/renderers');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Renderers.Reports.Delete');
