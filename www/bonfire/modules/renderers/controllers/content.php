...
class content extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Renderers.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Renderers.Content.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_renderers())
			{
				...
				Template::redirect(SITE_AREA .'/content/renderers');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Renderers.Content.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/renderers');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Renderers.Content.Delete');
