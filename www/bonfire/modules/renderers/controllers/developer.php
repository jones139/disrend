...
class developer extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Renderers.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Renderers.Developer.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_renderers())
			{
				...
				Template::redirect(SITE_AREA .'/developer/renderers');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Renderers.Developer.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/renderers');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Renderers.Developer.Delete');
